		...
		<div class="row">
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					<img src="images/services/android-app-development/android-app-development.webp" alt="Android App Development" class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
			<div class="col-lg-7 block-1 wow fadeIn my-auto">
				<div class="common-heading text-l pl25">
					...
					<p>Did you know? Android accounts for 88% of the global smartphone market, with Google’s Android OS powering over 2 billion smart devices.<a href="{{url('/')}}" target="_blank">AppsNation</a>is making the most of it with top-talented Android developers—more like Android wizards—striving to create your innovative, unique Android app.</p>
					<p>AppsNation is a data-driven Android app development agency that relies on analytics and insights to build impactful applications. We empower startups, SMBs, and large enterprises with solutions that help them thrive in the industry and make a bold statement through remarkable Android apps. AppsNation designs and develops Android applications with visually appealing UI/UX that perform flawlessly across all devices, regardless of screen size.</p>
