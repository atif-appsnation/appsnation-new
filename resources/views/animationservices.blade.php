			...
			<div class="row">
				<div class="col-lg-5">
					<div class="image-block wow fadeIn">
						<img src="images/banner/animation-banner-img.png" alt="Animation Development"
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 block-1 wow fadeIn pt-3 pt-sm-3 pt-md-3 pt-lg-0">
					<img src="images/banner/animation-graphic.png" alt="AR Game Changer" class="img-fluid" width="100%"
						height="100%">
				</div>
