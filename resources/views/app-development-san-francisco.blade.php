		...
		<div class="row">
			...
			<div class="col-lg-5">
				<div class="image-block wow fadeIn">
					<img src="images/locations/san-francisco/san-francisco.webp" alt="San Francisco" class="img-fluid no-shadow" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 block-1 wow fadeIn">
				<img src="images/locations/san-francisco/scale-your-business.webp" alt="Scale Your Business" class="img-fluid">
			</div>
		</div>
	</div>
</section>
