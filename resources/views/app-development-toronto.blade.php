			...
			<div class="col-lg-7 block-1 wow fadeIn my-auto">
				<div class="common-heading text-l pl25">
					<div data-text="Mobile" class="light-bg-text bg-text">
						<h2>Top<span class="flup-theme"> Mobile App Development</span><br> Company in Toronto</h2>
					</div>
					<p>AppsNation is a business-grade, top mobile app development Agency in Toronto helping startups and solopreneurs, founders, investors and small to medium-sized enterprises meet their revenue targets with mobile applications – faster, smarter and better. While we have mastered our technical skills for years in the industry, we have developed people, processes and policies that make us 100% more reliable and 10X faster than typical mobile app developers in Toronto. </p>
				</div>
			</div>
			<div class="col-lg-5">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 block-1 wow fadeIn my-auto">
				<div class="common-heading text-l pl25">
					<div data-text="Mobile" class="light-bg-text bg-text">
						<h2 class="text-white">Scale Your Business Effortlessly with a Result-Driven<span class="flup-theme"> Mobile App Development</span> Company in Toronto</h2>
					</div>
					<p class="text-white">You cannot lag behind when 96% of the Toronto population is using smartphones, and 84% of businesses consider mobile apps as a prerequisite in doing business. So, you must invest in mobile app development in Toronto to digitalize yourself.</p>
					<p class="text-white">Partner with a leading mobile app development company in Toronto to translate your unique business needs into innovative solutions and establish yourself as an industry leader.</p>
			...
			<div class="col-12">
				<div class="common-heading ptag">
					<div data-text="Our Services" class="light-bg-text bg-text text-center">
						<h2>App Development Services in <span>Toronto</span></h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-12">
				<div class="common-heading ptag wow fadeIn">
					<div data-text="Process" class="light-bg-text bg-text mt-5">
						<h2>Our <span>App</span> Development Process in Toronto</h2>
					</div>
			...
			<div class="col-12">
				<div class="common-heading ptag wow fadeIn text-center">
					<div data-text="Solutions" class="light-bg-text bg-text mt-5 text-center">
						<h2><span>Solutions</span> We’ve Conquered As An Elite Custom <span>Mobile App Development Company</span> in Toronto</h2>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row wow fadeIn">
			<div class="col-lg-6 my-auto">
				<div class="common-heading">
					<div data-text="Developers" class="dark-bg-text bg-text">
						<h2><span>Expand Your Market Presence with Our Top Mobile App </span>Development Company in Toronto</h2>
					</div>
					<p class="pt-2">We are the No.1 mobile app development company in Toronto that offer impeccable solutions under cost-effective rates. We build high-quality, user-friendly mobile apps that drive growth and help you reach more customers & generate massive revenue. With our award-winning solutions and industry expertise, we help you in keeping ahead of your rivals.</p>
					<a href="{{url('/contact-us')}}" class="niwax-btn button-arounder btn wow fadeIn mt-3 py-2 px-3" data-wow-delay="0.8s">Get Consultation <i class="fas fa-chevron-right fa-ani"></i></a>
				</div>
			</div>
