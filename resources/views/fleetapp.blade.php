	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-sm-12 col-md-6 wow fadeIn text-end">
				<img src="images/solutions/fleet-app-1.webp" alt="Fleet App" class="img-fluid no-shadow" width="100%" height="100%" />
			</div>
		</div>
	</div>
</section>
		...
		<div class="row mt-5">
			...
			<div class="col-lg-6 block-1 wow fadeIn my-auto">
				<div class="common-heading listSec text-l pl25">
					<ul>
						<li> <img class="lazy loaded" src="images/solutions/booking.svg" width="100%" height="100%" alt="search" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/services.svg" width="100%" height="100%" alt="services" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/promotions-and-discounts.svg" width="100%" height="100%" alt="property" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/reviews-ratings-management.svg" width="100%" height="100%" alt="booking" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/services-management.svg" width="100%" height="100%" alt="mortgage" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/notifications-alerts.svg" width="100%" height="100%" alt="promotions" data-was-processed="true">
	...
	<div class="container">
			...
			<div class="col-lg-6 block-1 wow fadeIn my-auto">
				<div class="common-heading listSec text-l pl25">
					<ul>
						...
						<li> <img class="lazy loaded" src="images/solutions/user-management.svg" width="100%" height="100%" alt="content" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/reviews-and-ratings.svg" width="100%" height="100%" alt="user" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/services.svg" width="100%" height="100%" alt="management" data-was-processed="true">
		...
		<div class="row mt-5">
			<div class="col-lg-6 block-1 my-auto wow fadeIn">
				<div class="common-heading listSec text-l pl25">
					<ul>
						<li> <img class="lazy loaded" src="images/solutions/content-management.svg" width="100%" height="100%" alt="promotions" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/services.svg" width="100%" height="100%" alt="bookings" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/promotions-and-discounts.svg" width="100%" height="100%" alt="reviews" data-was-processed="true">
						...
						<li> <img class="lazy loaded" src="images/solutions/reviews-and-ratings.svg" width="100%" height="100%" alt="notifications" data-was-processed="true">
			...
			<div class="col-lg-6">
				<div class="image-block wow fadeIn">
					<img src="images/solutions/fleet-app-3.webp" alt="Fleet App" class="img-fluid no-shadow" width="100%" height="100%" />
				</div>
			</div>
		</div>
	</div>
