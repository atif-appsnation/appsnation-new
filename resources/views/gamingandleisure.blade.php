...
<div class="statistics-wrap my-5">
	<div class="container">
		<div class="row small mt0">
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-5 mt-4 mt-md-4 mt-lg-0 text-end wow fadeInRight">
				<img class="img-fluid" src="images/industries/game-app-1.webp">
			</div>
		</div>
	</div>
</div>
...
<section class="service">
	<div class="row wow fadeIn">
		<div class="col-12 col-sm-12 col-md-6 img-container">
			<img src="images/industries/game-app-2.webp" class="img-fluid image">
		</div>
		<div class="col-12 col-sm-12 col-md-6 img-container">
			<img src="images/industries/game-app-3.webp" class="img-fluid image">
		</div>
	</div>
</section>
<!--End Why-->
