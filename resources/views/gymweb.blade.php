		...
		<div class="row">
			...
			<img src="images/case-studies/gym-web/header-logo.webp" class="img-fluid" alt="Gym Web Logo">
				<div class="bread-titlev2 mt-4">
					...
					<p class="text-white pt-3">BEST FITNESS WEBSITE</p>
				</div>
			</div>
...
<section class="gym-sitemap py-5">
	...
	<div class="gym-sitemap-web-img pt-3 wow fadeIn" data-wow-delay="0.4s">
	...
	<div class="container">
		...
		<div class="row mt-5 wow fadeIn" data-wow-delay="0.6s">
			...
			<div class="col-lg-6 mt-5 my-lg-auto text-end">
				...
				<h5 class="gym-sub-heading">Services Management</h5>
...
<section class="gym-features py-5">
	<div class="container">
		...
		<div class="row mt-5 wow fadeIn" data-wow-delay="0.4s">
			...
			<div class="col-lg-6 mt-5 mt-lg-0 text-end">
				<img src="images/case-studies/gym-web/gym-web-visual-1.webp" alt="Gym Web Visuals" class="img-fluid">
			</div>
		</div>

		<div class="row mt-5 wow fadeIn" data-wow-delay="0.6s">
			<div class="col-lg-6 text-start">
				<img src="images/case-studies/gym-web/gym-web-visual-2.webp" alt="Gym Web Visuals" class="img-fluid">
			</div>
			<div class="col-lg-6 mt-5 my-lg-auto text-end">
