		...
		<div class=" container">
			<div class="row mb-3">
				<div class="col-lg-5">
					<div class="image-block wow fadeIn">
						<img src="images/services/industrial-automation/automation-service-img.webp"
			...
			<div class="row mt-5 wow fadeIn">
				<div class="col-12 col-md-6 col-lg-3">
					<div class="card">
						<div class="card-body text-center mt-3 mt-md-0">
							<img src="images/services/industrial-automation/scada-hmi-icon.webp" alt="SCADA/HMI"
				...
				<div class="col-12 col-md-6 col-lg-3 mt-3 mt-md-0">
					<div class="card">
						<div class="card-body text-center">
							<img src="images/services/industrial-automation/industrial-controls-icon.webp"
				...
				<div class="col-12 col-md-6 col-lg-3 mt-3 mt-md-3 mt-lg-0">
					<div class="card">
						<div class="card-body text-center">
							<img src="images/services/industrial-automation/system-automation-icon.webp"
				...
				<div class="col-12 col-md-6 col-lg-3 mt-3 mt-md-3 mt-lg-0">
					<div class="card">
						<div class="card-body text-center">
							<img src="images/services/industrial-automation/upgrade-and-repair-icon.webp"
				...
				<div class="col-12 col-md-6 col-lg-3 mt-3">
					<div class="card">
						<div class="card-body text-center mt-3 mt-md-0">
							<img src="images/services/industrial-automation/machine-vision-icon.webp" alt="Machine Vision"
								class="img-fluid py-3 ind-auto-img" width="auto" height="auto">
				...
				<div class="col-12 col-md-6 col-lg-3 mt-3">
					<div class="card">
						<div class="card-body text-center">
							<img src="images/services/industrial-automation/extended-reality-automatio-icon.webp"
				...
				<div class="col-12 col-md-6 col-lg-3 mt-3">
					<div class="card">
						<div class="card-body text-center">
							<img src="images/services/industrial-automation/embedded-systems-icon.webp"
				...
				<div class="col-12 col-md-6 col-lg-3 mt-3">
					<div class="card">
						<div class="card-body text-center">
							<img src="images/services/industrial-automation/industrial-40-icon.webp" alt="Industrial 4.0"
								class="img-fluid py-3 ind-auto-img" width="auto" height="auto">
		...
		<div class="container">
			...
			<div class="row upset justify-content-center mt30">
				...
				<div class="col-12 col-md-6 col-lg-4 mt-3 mt-md-0">
					<div class="timeline wow fadeIn h-100">
						<div class="timeline-year">
							<img src="images/why-choose/50+-expert-android-developers.svg"
				...
				<div class="col-lg-12 wow fadeIn">
					<div class="card green-bg p-4">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-6">
									<img src="images/services/industrial-automation/industrial-automation-img-1.webp"
					...
					<div class="card green-bg p-4">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-lg-6 mt-4 mt-lg-0">
									<img src="images/services/industrial-automation/industrial-automation-img-2.webp"
										alt="Unplanned Downtime Support" class="d-block mx-auto" width="auto" height="auto">
								</div>
							</div>
						</div>
				...
				<div class="col-lg-12 wow fadeIn">
					<div class="card green-bg p-4">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-6">
									<img src="images/services/industrial-automation/industrial-automation-img-3.webp"
										alt="Unplanned Downtime Support" class="d-block mx-auto" width="auto" height="auto">
								</div>
