		...
		<div class="row">
			<div class="col-lg-5 my-auto">
				<div class="image-block wow fadeIn">
					<img src="images/services/connected-devices/connected-devices.webp" alt="Connected Devices" class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
				<div class="service-card-app home-services gradient-border h-100">
					<div class="services-img-div">
						<img src="images/services/connected-devices/iot-app-development.svg" alt="IoT App Development" class="img-fluid" width="100%" height="100%">
					</div>
			...
			<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
				<div class="service-card-app home-services gradient-border h-100">
					<div class="services-img-div">
						<img src="images/services/connected-devices/wearable-app-development.svg" alt="Wearable App Developmen" class="img-fluid" width="100%" height="100%">
					</div>
					<div class="service-heading">
			...
			<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
				<div class="service-card-app home-services gradient-border h-100">
					<div class="services-img-div">
						<img src="images/services/connected-devices/industrial-automation.svg" alt="Industrial Automation" class="img-fluid" width="100%" height="100%">
					</div>
					<div class="service-heading">
