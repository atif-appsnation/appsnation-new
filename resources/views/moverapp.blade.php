	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-sm-12 col-md-6 wow fadeIn text-end">
				<img src="images/solutions/mover-app-1.webp" alt="Mover App" width="100%" height="100%" class="img-fluid no-shadow" />
			</div>
		</div>
	</div>
</section>
		...
		<div class="row mt-5">
			<div class="col-lg-6 wow fadeIn">
				<div class="image-block">
					<img src="images/solutions/mover-app-1.webp" alt="Mover App" class="img-fluid no-shadow" width="100%" height="100%" />
				</div>
			</div>
			<div class="col-lg-6 block-1 my-auto wow fadeIn">
				<div class="common-heading listSec text-l pl25">
					<ul>
						<li> 
							<img class="lazy loaded" src="images/solutions/dashboard-analytics.svg" width="100%" height="100%" alt="search" data-was-processed="true">
						...
						<li> 
							<img class="lazy loaded" src="images/solutions/user-management.svg" width="100%" height="100%" alt="services" data-was-processed="true">
		...
		<div class="row mt-5">
			<div class="col-lg-6 block-1 wow fadeIn my-auto">
				<div class="common-heading listSec text-l pl25">
					<ul>
						<li> 
							<img class="lazy loaded" src="images/solutions/check-out.svg" width="100%" height="100%" alt="check" data-was-processed="true">
						...
						<li> 
							<img class="lazy loaded" src="images/solutions/payment-gateways.svg" width="100%" height="100%" alt="payment" data-was-processed="true">
			...
			<div class="col-lg-6 wow fadeIn">
				<div class="image-block">
					<img src="images/solutions/mover-app-2.webp" alt="Mover App" class="img-fluid no-shadow" width="100%" height="100%"/>
				</div>
			</div>
		</div>
	</div>
...
<section class="solutions py-5">
	<div class="container">
		...
		<div class="row mt-5">
			<div class="col-lg-6 wow fadeIn">
				<div class="image-block">
					<img src="images/solutions/mover-app-3.webp" alt="Mover App" class="img-fluid no-shadow" width="100%" height="100%" />
				</div>
			</div>
			<div class="col-lg-6 block-1 my-auto wow fadeIn">
				<div class="common-heading listSec text-l pl25">
		...
		<div class="row mt-5">
			...
			<div class="col-lg-6 wow fadeIn">
				<div class="image-block">
					<img src="images/solutions/mover-app-4.webp" alt="Mover App" class="img-fluid no-shadow" width="100%" height="100%"/>
				</div>
			</div>
		</div>
	</div>
