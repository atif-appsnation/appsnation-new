		...
		<div class="row justify-content-between">
			<div class="col-md-12 col-lg-6 order-2 order-lg-1 my-auto wow fadeIn">
				...
				<div class="bread-titlev2 common-heading">
					...
					<p class="mt20 text-white" data-wow-delay=".4s">Here at <a href="{{url('/')}}" target="_blank"> AppsNation</a>,We at Tekrevol offer you top-of-the-line social media marketing services that guarantee high engagement from your target audiences, drive traffic and generate meaningful new sales leads for your business.
					...
					<div class="case-study-box-items">
						<div class="thumb">
							...
							<div class="post-box-items">
								<ul>
									<li>
										<a>Instagram Marketing Services
										</a>
									</li>
									<li>
										<a>TikTok Marketing Services
										</a>
									</li>
								</ul>
								<ul>
									<li>
										<a>LinkedIn Marketing Services
										</a>
									</li>
									<li>
										<a>Facebook Marketing Services
				...
				<div class="col-xxl-6">
					<div class="main-box">
						...
						<div class="box bg-1 wow fadeInUp wow" data-wow-delay=".2s">
							<div class="title-items">
								<h3>
									<a href="javascript:void(0)">TikTok
									</a>
								</h3>
							...
							<div class="project-content">
								<h3>TikTok Marketing Services
								</h3>
								<p>TikTok is another platform to give a boost to your online presence. It is all about creating and sharing short videos that are trending all
						...
						<div class="box bg-2  wow fadeInUp wow" data-wow-delay=".4s">
							<div class="title-items">
								<h3>
									<a href="javascript:void(0)">LinkedIn
									</a>
								</h3>
							...
							<div class="project-content">
								<h3>LinkedIn Marketing Services
								</h3>
								<p>LinkedIn helps you market your products and services to potential target audiences and also helps you
						...
						<div class="box bg-3 wow fadeInUp wow" data-wow-delay=".6s">
							...
							<div class="project-content">
								<h3>Facebook Marketing Services
								</h3>
								<p>Facebook is a public social media platform that acts as an access point for you and your target audience.
		...
		<div class="row upset justify-content-center mt30">
			<div class="col-12 col-md-6 col-lg-4">
				<div class="timeline wow fadeIn h-100">
					...
					<h3 class="title">Set Clear
						Goals</h3>
					<p class="description">We collaborate with you to define specific objectives, and set clear goals, whether it involves increasing brand awareness, generating leads, or boosting sales. Establishing clear goals ensures that every effort is fully aligned with your business vision.
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-md-0">
				<div class="timeline wow fadeIn h-100">
					...
					<h3 class="title">Research your
						Target Audience</h3>
					<p class="description">We dive deep into understanding your ideal customers—their demographics, interests, and online behaviors—so we can carefully tailor a strategy that speaks directly to them.
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3 mt-lg-0">
				<div class="timeline wow fadeIn h-100">
					...
					<h3 class="title">Determine Social Media Platforms Aligned with Your Brand
					</h3>
					<p class="description">Our team identifies the social media platforms that align with your brand and audience. We ensure your business is visible where it matters the most, ensuring your message reaches to the right people through the right medium.
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					...
					<h3 class="title">Set Metrics and
						KPIs
					</h3>
					<p class="description">As a competent social media management company, we set benchmarks that are easily measurable like engagement rates, follower growth, and conversions. These KPIs help us track success and adjust real-time strategies to maximize your ROI.
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					...
					<h3 class="title">Create Engaging
						Content</h3>
					<p class="description">We craft compelling content that captures your brand’s identity and also resounds with your audience. Our team ensures a mix of visuals, videos, and posts that drive interaction with a loyal community.
			...
			<div class="col-12 col-md-6 col-lg-4 mt-3">
				<div class="timeline wow fadeIn h-100">
					...
					<h3 class="title">Schedule Posts on
						Social Media
					</h3>
					<p class="description">We handle the scheduling of your content, making sure it’s posted at optimal times to maximize reach and engagement. Our goal is to keep reminding your audiences about your brand at regular intervals.
