    ...
    <div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-sm-12 col-md-6 wow fadeIn text-end">
				<img src="images/solutions/sports-app-1.webp" alt="Sports App" class="img-fluid no-shadow" width="100%" height="100%"/>
			</div>
		</div>
	</div>
</section>
    ...
    <div class="container">
            ...
            <div class="col-lg-6 block-1 wow fadeIn my-auto">
                <div class="common-heading listSec text-l pl25">
                    <ul>
                        ...
                        <li>
                            <img class="lazy loaded" src="images/solutions/reviews-and-ratings.svg" width="100%" height="100%" alt="booking" data-was-processed="true">
        ...
        <div class="row mt-5">
            <div class="col-lg-6 block-1 wow fadeIn my-auto">
                <div class="common-heading listSec text-l pl25">
                    <ul>
                        <li> <img class="lazy loaded" src="images/solutions/promotions-and-discounts.svg" width="100%" height="100%" alt="check" data-was-processed="true">
                        ...
                        <li> <img class="lazy loaded" src="images/solutions/history.svg" width="100%" height="100%" alt="payment" data-was-processed="true">
                        ...
                        <li> <img class="lazy loaded" src="images/solutions/content-management.svg" width="100%" height="100%" alt="wallet" data-was-processed="true">
                        ...
                        <li> <img class="lazy loaded" src="images/solutions/payment-gateways.svg" width="100%" height="100%" alt="history" data-was-processed="true">
                        ...
                        <li> <img class="lazy loaded" src="images/solutions/notifications-alerts.svg" width="100%" height="100%" alt="reviews" data-was-processed="true">
            ...
            <div class="col-lg-6 wow fadeIn">
                <div class="image-block">
                    <img src="images/solutions/sports-app-2.webp" alt="Sports App" class="img-fluid no-shadow" width="100%" height="100%" />
                </div>
            </div>
        </div>
    </div>
...
<section class="solutions py-5">
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-lg-6 wow fadeIn">
                <div class="image-block">
                    <img src="images/solutions/sports-app-3.webp" alt="Sports App" class="img-fluid no-shadow" width="100%" height="100%" />
                </div>
            </div>
            <div class="col-lg-6 block-1 wow fadeIn my-auto">
                <div class="common-heading listSec text-l pl25">
        ...
        <div class="row mt-5">
            <div class="col-lg-6 block-1 wow fadeIn my-auto">
                <div class="common-heading listSec text-l pl25">
                    <ul>
                        <li>
                            <img class="lazy loaded" src="images/solutions/booking.svg" width="100%" height="100%" alt="promotions" data-was-processed="true">
            ...
            <div class="col-lg-6 wow fadeIn">
                <div class="image-block">
                    <img src="images/solutions/sports-app-4.webp" alt="Sports App" class="img-fluid no-shadow" width="100%" height="100%" />
                </div>
            </div>
        </div>
    </div>
