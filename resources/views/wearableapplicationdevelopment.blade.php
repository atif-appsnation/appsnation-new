			...
			<div class="row">
				<div class="col-lg-5 my-auto wow fadeIn">
					<div class="image-block">
						<img src="images/services/wearable-app-development/wearable-app-development.webp"
...
<span>App Development Services </span>  for Wearable Devices</h2>
			...
			<div class="row mt-5">
				<div class="col-sm-12 col-md-12 col-lg-4 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/custom-wearable-device-app-development.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 mt-lg-0 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/wearable-app-ui-ux-design.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 mt-lg-0 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/android-wearable-app-development.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/apple-watch-application-development.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/iot-based-werable-app-development.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/augument-reality-app-development.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/wearables-apps-compatibility-testing.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/recreating-existing-apps.svg"
				...
				<div class="col-sm-12 col-md-12 col-lg-4 mt-3 wow fadeIn">
					<div class="service-card-app home-services gradient-border h-100">
						<div class="services-img-div">
							<img src="images/services/wearable-app-development/maintenance-and-support.svg"
	...
	<section class="service py-5">
		...
		<div class="row mt-5">
			<div class="col-lg-6">
				<div class="image-block wow fadeIn">
					<img src="images/services/wearable-app-development/smart-band-apps.webp" alt="Smart Band Apps"
		...
		<div class="row mt-5">
			...
			<div class="col-lg-6 mt-4 mt-sm-4 mt-md-3">
				<div class="image-block wow fadeIn">
					<img src="images/services/wearable-app-development/apple-watch-apps.webp" alt="Apple Watch Apps"
						class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
		</div>
		<div class="row mt-5">
			<div class="col-lg-6">
				<div class="image-block wow fadeIn">
					<img src="images/services/wearable-app-development/google-glass-apps.webp" alt="Google Glass Apps"
						class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
			<div class="col-lg-6 block-1 wow fadeIn my-auto">
		...
		<div class="row mt-5">
			...
			<div class="col-lg-6 mt-4 mt-sm-4 mt-md-3">
				<div class="image-block wow fadeIn">
					<img src="images/services/wearable-app-development/virtual-reality-apps.webp" alt="Virtual Reality Apps"
						class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
		</div>
		<div class="row mt-5">
			<div class="col-lg-6">
				<div class="image-block wow fadeIn">
					<img src="images/services/wearable-app-development/iot-wearable-apps.webp" alt="IoT Wearable Apps"
						class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
			<div class="col-lg-6 block-1 wow fadeIn my-auto">
		...
		<div class="row mt-5">
			...
			<div class="col-lg-6 mt-4 mt-sm-4 mt-md-3">
				<div class="image-block wow fadeIn">
					<img src="images/services/wearable-app-development/wearable-payment-app.webp" alt="Wearable Payment App"
						class="img-fluid no-shadow" width="100%" height="100%">
				</div>
			</div>
		</div>
